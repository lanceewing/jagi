...
public class InstructionObjectOnLand extends InstructionUni
{
     ...
     */
    public InstructionObjectOnLand(InputStream stream, LogicReader reader, short bytecode, short engineEmulation) throws IOException
    {
    ...
    {
        logicContext.getViewTable().onLand(p1);
        return 2;
    }
