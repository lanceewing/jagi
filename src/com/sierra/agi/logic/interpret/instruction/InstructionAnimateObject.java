...
public class InstructionAnimateObject extends InstructionUni
{
     ...
     */
    public InstructionAnimateObject(InputStream stream, LogicReader reader, short bytecode, short engineEmulation) throws IOException
    {
    ...
    {
        logicContext.getViewTable().animateObject(p1);
        return 2;
    }
