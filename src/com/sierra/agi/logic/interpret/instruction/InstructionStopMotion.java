...
public class InstructionStopMotion extends InstructionUni
{
     ...
     */
    public InstructionStopMotion(InputStream stream, LogicReader reader, short bytecode, short engineEmulation) throws IOException
    {
    ...
    {
        logicContext.getViewTable().stopMotion(p1);
        return 2;
    }
