 ...
 * @version 0.00.00.01
 */
public class InstructionCall extends InstructionUni implements Compilable
{
    /** 
     ...
     */
    public InstructionCall(InputStream stream, LogicReader reader, short bytecode, short engineEmulation) throws IOException
    {
