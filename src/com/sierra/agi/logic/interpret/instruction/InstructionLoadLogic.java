 ...
 * @version 0.00.00.01
 */
public class InstructionLoadLogic extends InstructionUni implements Compilable
{
    /** 
     ...
     */
    public InstructionLoadLogic(InputStream stream, LogicReader reader, short bytecode, short engineEmulation) throws IOException
    {
